 ...
 */
@Component("orgEnrollmentRowMapper")
public class OrgEnrollmentRowMapper implements RowMapper<EnrollmentBean>{
    @Override
    public EnrollmentBean mapRow(ResultSet rs, int rowNum) throws SQLException {
        ...
        enrollmentBean.setHasRepresentative(rs.getBoolean("has_representative"));
        enrollmentBean.setOrgAddress(rs.getString("org_address"));
        enrollmentBean.setOrganizationName(rs.getString("name"));
        enrollmentBean.setOrgVatOrPanNo(rs.getString("company_certificate"));
        enrollmentBean.setOrgStampPhotoId(rs.getLong("leo.org_stamp_id"));
